...
import 'package:ejercitando/widgets/rectangleIndicator.dart';
import 'package:flutter/material.dart';

class MenuPager extends StatefulWidget {
  final List<Pages> children;
...
class _MenuPagerState extends State<MenuPager> {
    ...
    return Container(
      child: Stack(
        children: <Widget>[
          ...
          _renderBottomNav(this.widget.children.map((page) => page.icon).toList()),
          _renderContents(
  ...
  Widget _renderContents(List<Pages> pages, int selectedPageIndex,
  ...
  Widget _renderPage(Pages page, int index, int selectedPageIndex) {
